...
-- -----------------------------------------------------
-- Table `mydb`.`horario_profesor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`horario_profesor` (
  ...
  CONSTRAINT `fk_horarioProfesor_horarioGrupo1`
    ...
    REFERENCES `mydb`.`horario_grupo` (`id_horario_grupo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`horario_grupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`horario_grupo` (
  `id_horario_grupo` INT(4) NOT NULL COMMENT '',
  `dia_semana` ENUM('Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes') NULL COMMENT '',
  `hora_inicio` TIME(0) NULL COMMENT '',
  `hora_final` TIME(0) NULL COMMENT '',
  ...
  CONSTRAINT `fk_horarioGrupo_horarioProfesor1`
    ...
    REFERENCES `mydb`.`horario_profesor` (`id_horario_profesor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`faltas` (
  ...
  CONSTRAINT `fk_faltas_alumnos1`
    ...
    REFERENCES `mydb`.`alumnos` (`id_alumno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`alumno_grupos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`alumno_grupos` (

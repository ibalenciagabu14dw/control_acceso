$(document).ready(function() {
	...
	$('#resultado').on("click",".celda",function () {
		...
		.done(function(result) {
    		...
    		formulario += "<input type='text' id='password' name='password' class='form-control' value='"+result.password+"'>";
    		formulario += "</div>";
  			formulario += "</div><br/>";
    		...
    		formulario += "<input type='text' id='admin' name='admin' class='form-control' value='"+result.admin+"'>";
    		formulario += "</div>";
  			formulario += "</div><br/>";

$(document).ready(function() {
	...
	$('#resultado').on("click",".celda",function () {
		...
		.done(function(result) {
    		...
    		formulario += "<input type='number' id='numero' name='numero' class='form-control has-feedback' value='"+result[0].numero+"'>";
    		...
    		formulario += "<input type='number' id='piso' name='piso' class='form-control has-feedback' value='"+result[0].piso+"'>";
			...
			formulario += "<label for='capacidad' class='input-group-addon'>CAPACIDAD</label>";         		
       		formulario += "<input type='number' id='capacidad' name='capacidad' class='form-control has-feedback' value='"+result[0].capacidad+"'>";

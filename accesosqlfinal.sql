...
CREATE TABLE IF NOT EXISTS `control_acceso`.`alumnos` (
  ...
  `correo` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `foto` LONGBLOB NULL DEFAULT NULL COMMENT '',
  `tarjetaActivada` TINYINT(1) NULL DEFAULT NULL COMMENT '',
  `num_tarjeta` INT(11) NULL DEFAULT NULL COMMENT '',
  `presencia` TINYINT(1) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `control_acceso`.`grupo` (
  ...
  `nombre` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `tipo` ENUM('Bachiller','FP') NULL DEFAULT NULL COMMENT '',
  `idsubgrupo` INT(11) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `control_acceso`.`aula` (
  ...
  `numero` VARCHAR(4) NULL DEFAULT NULL COMMENT '',
  `piso` VARCHAR(2) NULL DEFAULT NULL COMMENT '',
  `capacidad` INT(4) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `control_acceso`.`profesor` (
  ...
  `apellidos` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `correo` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `contraseña` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `foto` LONGBLOB NULL DEFAULT NULL COMMENT '',
  `tarjetaActivada` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `num_tarjeta` INT(11) NULL DEFAULT NULL COMMENT '',
  `presencia` TINYINT(1) NULL DEFAULT NULL COMMENT '',
  `admin` TINYINT(1) NULL DEFAULT NULL COMMENT 'tabla Profesor',
...
CREATE TABLE IF NOT EXISTS `control_acceso`.`horario_profesor` (
  ...
  `dia_semana` ENUM('Lunes','Martes','Miercoles','Jueves','Viernes') NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `control_acceso`.`faltas` (
  ...
  `observaciones` VARCHAR(300) NULL DEFAULT NULL COMMENT '',
